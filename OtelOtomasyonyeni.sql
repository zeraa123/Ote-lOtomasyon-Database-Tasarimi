...
/****** Object:  Database [OtelOtomasyonu]    Script Date: 12.05.2023 20:09:09 ******/
CREATE DATABASE [OtelOtomasyonu]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'OtelOtomsyonu', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\OtelOtomsyonu.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'OtelOtomsyonu_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\OtelOtomsyonu_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
